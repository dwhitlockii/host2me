...
RUN apt-get update \
    && apt-get install -y wget curl gnupg2 ca-certificates unzip fonts-liberation libasound2 libatk-bridge2.0-0 libatk1.0-0 libcups2 libdbus-1-3 libgdk-pixbuf2.0-0 libnspr4 libnss3 libx11-xcb1 libxcomposite1 libxdamage1 libxrandr2 xdg-utils libu2f-udev libvulkan1 libgbm1 libgtk-3-0 xvfb \
