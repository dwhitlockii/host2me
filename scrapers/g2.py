...
URL = "https://r.jina.ai/https://www.g2.com/categories/web-hosting"
DEBUG_PATH = "output/g2_debug.html"
...
def fetch_companies(log=None):
    ...
    if log:
        log(f"[G2] Extracted {len(companies)} companies")
    return companies
